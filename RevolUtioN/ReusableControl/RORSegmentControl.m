...
//    self.frame = frame;
    ...
    for (int i=0; i<num; i++)
    {
        ...
        RORSegmentButton *btn = [[RORSegmentButton alloc]initWithFrame:CGRectMake(i*SEGMENT_BUTTON_WIDTH, 0, SEGMENT_BUTTON_WIDTH, SEGMENT_BUTTON_HEIGHT) Style:style andIndex:i];
