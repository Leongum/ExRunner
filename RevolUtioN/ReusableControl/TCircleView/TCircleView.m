...
- (CAShapeLayer *)generateMaskLayer {
    ...
    if ([TCircleView clockWiseType]) {
        path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.frame.size.width / 2, self.frame.size.height / 2) radius:self.frame.size.width / 2.5 startAngle:[TCircleView startAngle] endAngle:[TCircleView endAngle] clockwise:YES];
    } else {
        path = [UIBezierPath bezierPathWithArcCenter:CGPointMake(self.frame.size.width / 2, self.frame.size.height / 2) radius:self.frame.size.width / 2.5 startAngle:[TCircleView endAngle] endAngle:[TCircleView startAngle] clockwise:NO];
    }
